...
class LZMADecoder extends CoderBase {
    ...
    public byte[] getOptionsAsProperties(Object opts) throws IOException {
        ...
        byte[] o = new byte[5];
        o[0] = (byte) ((((options.getPb() * 5) + options.getLp()) * 9) + options.getLc());
