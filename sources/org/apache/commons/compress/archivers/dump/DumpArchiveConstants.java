...
public final class DumpArchiveConstants {
    ...
    public enum SEGMENT_TYPE {
        ...
        private SEGMENT_TYPE(int code2) {
            this.code = code2;
        }

        public static SEGMENT_TYPE find(int code2) {
    ...
    public enum COMPRESSION_TYPE {
        ...
        private COMPRESSION_TYPE(int code2) {
            this.code = code2;
        }

        public static COMPRESSION_TYPE find(int code2) {
