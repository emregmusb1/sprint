...
public class DoubleKeyValueMap<K1, K2, V> {
    ...
    public void put(K1 key1, K2 key2, V value) {
        if (key1 != null && key2 != null && value != null) {
            if (this.k1_k2V_map.containsKey(key1)) {
                ...
                this.k1_k2V_map.put(key1, concurrentHashMap);
                return;
            }
    ...
    public Collection<V> getAllValues() {
        ...
        if (k1Set != null) {
            ...
            for (K1 k1 : k1Set) {
                ConcurrentHashMap<K2, V> value1 = this.k1_k2V_map.get(k1);
                if (!(value1 == null || (values = value1.values()) == null)) {
    ...
    public boolean containsKey(K1 key1, K2 key2) {
        ConcurrentHashMap<K2, V> value1;
        if (!this.k1_k2V_map.containsKey(key1) || (value1 = this.k1_k2V_map.get(key1)) == null) {
            return false;
        }
